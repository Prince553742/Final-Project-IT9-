    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="mb-6 relative">
            ...
            <div class="pl-4">
                ...
                <p class="text-sm text-gray-500">Update task details, reassign, or change status.</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.tasks.update', $task) }}" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    ...
                    {{-- Action Buttons with large top margin --}}
                    <div class="flex justify-center gap-3 mt-12">
                        <a href="{{ route('admin.tasks') }}" class="px-5 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                            Cancel
                        </a>
