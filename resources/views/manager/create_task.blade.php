    ...
    <div class="py-6 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto bg-gray-100">
        ...
        <form action="{{ route('manager.tasks.store') }}" method="POST">
            ...
            <div class="flex justify-end gap-3 mt-8">
                <a href="{{ route('projects.show', $project->id) }}" class="px-5 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
                    Cancel
                </a>
